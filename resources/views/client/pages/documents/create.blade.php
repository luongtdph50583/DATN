            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">📄 Thêm Tài liệu - {{ $club->name }}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('club_manager.club.documents.store', $club->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                    value="{{ old('title') }}" required placeholder="Nhập tiêu đề tài liệu">
                                @error('title')
                            ...
                            <div class="mb-3">
                                <label for="file" class="form-label">File tài liệu <span
                                        class="text-danger">*</span></label>
                                <input type="file" name="file" class="form-control @error('file') is-invalid @enderror"
                                    required accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt">
                                <small class="text-muted">Định dạng: PDF, Word, Excel, PowerPoint, TXT</small>
                                @error('file')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
$oldLevels = old('access_level', []);
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                    rows="4"
                                    placeholder="Mô tả ngắn gọn về tài liệu này...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tags" class="form-control @error('tags') is-invalid @enderror"
                                    value="{{ old('tags') }}" placeholder="ví dụ: quy chế, hướng dẫn, biên bản">
                ...
                <div class="card mt-3 border-info">
                    <div class="card-body">
                        ...
                        <ul class="small mb-0">
                            ...
                            <li><strong>Tất cả thành viên:</strong> Tất cả thành viên CLB đều xem được (bao gồm cả các ban
                                chức năng)</li>
                            <li><strong>Chọn role cụ thể:</strong> Chỉ những role đó + role cao hơn mới xem được. Member
                                thường không xem được.</li>
