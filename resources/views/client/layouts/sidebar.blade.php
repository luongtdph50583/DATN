                                ...
                                @foreach($managedClubs as $club)
                                    <li class="submenu-item">
                                        ...
                                        <ul class="submenu list-unstyled ms-3">
                                            ...
                                            <li><a href="{{ route('club_manager.member_requests.index', ['club_id' => $club->id]) }}">
                                                <i class="fas fa-user-plus"></i> Yêu cầu tham gia
                                            </a></li>
                                            <li><a href="{{ route('club_manager.edit_request.index', ['club_id' => $club->id]) }}">
                                                <i class="fas fa-edit"></i> Đề xuất sửa CLB
                                            </a></li>
                                            <li><a href="{{ route('club_manager.interviews.index', ['club_id' => $club->id]) }}">
                                                <i class="fas fa-calendar-check"></i> Phỏng vấn
                                            </a></li>
                                            <li><a href="{{ route('club_manager.recruit.index', ['club_id' => $club->id]) }}">
                                                <i class="fas fa-users"></i> Tuyển thành viên
                                            </a></li>
                                            <li><a href="{{ route('club_manager.notifications.create', ['club_id' => $club->id]) }}">
