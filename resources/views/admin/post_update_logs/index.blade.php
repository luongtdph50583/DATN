...
@section('card-header')
    Lịch sử thay đổi bài viết
@endsection

@section('card-body')

    {{-- Form lọc --}}
    <form method="GET" action="{{ route('admin.post_update_logs.index') }}" class="mb-3">
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('admin.post_update_logs.index') }}" class="btn btn-secondary">Reset</a>
            </div>
        </div>
    </form>
            ...
            <tbody>
                @foreach($logs as $index => $log)
                                    <tr>
                                        ...
                                        <td>{{ $log->updatedBy->name ?? 'Không rõ' }}</td>
                    ...
                    $fieldLabels = [
                        ...
                        'delete_reason' => 'Lý do xóa',
                                    ...
                                    <td>
                                        {{-- Xem chi tiết log --}}
                                        <a href="{{ route('admin.post_update_logs.show', $log->id) }}" class="btn btn-warning btn-sm me-1" title="Xem">
