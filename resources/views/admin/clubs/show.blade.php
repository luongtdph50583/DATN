...
@section('card-body')
                    ...
                    <table class="table table-bordered table-striped mb-0">
                        ...
                        <tbody>
                            @php
                                ...
                                // Chỉ lấy các role ban quản lý (không bao gồm member)
                                $rolePriority = [
                                    'club_manager' => 1,
                                    'deputy_manager' => 2,
                                    'secretary' => 3,
                                ...
                                $sortedClubMembers = collect($clubMembers)
                            ...
                            @forelse($sortedClubMembers as $member)
                                <tr>
                                    ...
                                    <td>{{ isset($member['appointed_at']) ? \Carbon\Carbon::parse($member['appointed_at'])->format('d/m/Y') : '—' }}
                                    </td>
                                    <td>
    ...
    <div class="card mb-4 shadow-sm border-secondary">
        ...
        @if($club->advisor)
            <div class="row mb-2">
                <div class="col-md-4"><strong>Tên:</strong> {{ $club->advisor->name ?? '—' }}</div>
                <div class="col-md-4"><strong>Email:</strong> {{ $club->advisor->email ?? '—' }}</div>
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-4"><strong>Văn phòng:</strong> {{ $club->advisorFaculty->office_location ?? '—' }}</div>
            </div>
        @endif
