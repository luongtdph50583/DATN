        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('admin.users.index') }}">
                    ...
                    <span data-key="t-dashboards">Quản lí tài khoản</span>
                </a>
            </li>
            ...
            <!-- Quản lý quỹ -->
            <li class="nav-item">
                <a class="nav-link menu-link collapsed" data-bs-toggle="collapse" href="#quanliquy" role="button"
                    aria-expanded="false" aria-controls="quanliquy">
                    <i class="ri-wallet-line"></i> <span data-key="t-funds">Quản lý quỹ</span>
                </a>
                <div class="collapse" id="quanliquy">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.event_fund_requests.index') }}" class="nav-link"
                                data-key="t-fund-create">
                                <i class="ri-add-circle-line"></i> Yêu cầu cấp kinh phí
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.event_fund_settlements.index') }}" class="nav-link"
                                data-key="t-fund-create">
            ...
            <!-- Chi tiết CLB / Thống kê / Kế hoạch -->
