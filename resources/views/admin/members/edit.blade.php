...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h4 mb-1">Chỉnh sửa Thành viên</h1>
            <p class="text-muted small mb-0">#{{ $member->id }} - {{ $member->user->name }}</p>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.members.update', $member) }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-control bg-light">{{ $member->user->name }} ({{ $member->user->email }})</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="student_code" class="form-control @error('student_code') is-invalid @enderror"
                                   value="{{ old('student_code', $member->student_code) }}" required>
                ...
                <div class="d-flex gap-3 mt-4 pt-3 border-top">
                    ...
                    <a href="{{ route('admin.members.show', $member) }}" class="btn btn-secondary px-5">
