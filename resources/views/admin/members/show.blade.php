            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="info-group">
                        ...
                        <p>{{ $member->gender ? ucfirst($member->gender === 'male' ? 'Nam' : ($member->gender === 'female' ? 'Nữ' : 'Khác')) : '—' }}</p>
                    </div>

                    <div class="info-group">
                        <label>Ngày sinh</label>
                        <p>{{ $member->date_of_birth ? \Carbon\Carbon::parse($member->date_of_birth)->format('d/m/Y') : '—' }}</p>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="info-group">
                        ...
                        <p>{{ $member->issued_date ? \Carbon\Carbon::parse($member->issued_date)->format('d/m/Y') : '—' }}</p>
                    </div>
