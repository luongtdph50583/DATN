...
@section('card-body')
        <div class="container py-4">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header bg-light fw-bold">Ban quản lý & Thành viên</div>
                <div class="card-body">
                    <div class="row">
                        {{-- Thành viên --}}
                        <div class="col-md-6">
                            <h6 class="fw-semibold text-secondary mb-3">Thành viên</h6>
                            @php
    $roles_member = $request->clubRequestMembers->filter(fn($m) => $m->role === 'member');
                        ...
                        {{-- Ban quản lý --}}
                        <div class="col-md-6">
                            <h6 class="fw-semibold text-secondary mb-3">Ban quản lý</h6>
                            @php
